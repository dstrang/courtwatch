...
?>
        <div id="container">
            <ul>
                <li id="volunteers"><a href="volunteers.php"><img src="img/volunteers.png" /></a><p>Volunteers</p></li>
                <li id="forms"><a href="forms.php"><img src="img/forms.png" /></a><p>Forms</p></li>
                <li id="graphs"><a href="graphs.php"><img src="img/graphs.png" /></a><p>Graphs</p></li>
            </ul>
        </div>
...
?>
        <div id="container">
            <ul>
                <li id="profile"><a href="profile.php"><img src="img/volunteers.png" /></a><p>Profile</p></li>
                <li id="forms"><a href="forms.php"><img src="img/forms.png" /></a><p>Forms</p></li>
            </ul>
        </div>
